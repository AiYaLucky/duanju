package com.aiyalucky.duanju.CustomJzvd;
...
public class JzvdStdVideo extends JzvdStd {
    ...
    public JzvdStdVideo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void updateStartImage() {
        if (state == STATE_PLAYING) {
            ...
            startButton.setImageResource(R.drawable.icon_video_player);
