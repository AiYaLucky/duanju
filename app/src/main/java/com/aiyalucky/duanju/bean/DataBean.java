package com.aiyalucky.duanju.bean;
...
public class DataBean {
     ...
     */
    public static List<DataBean> getPictureData() {
        List<DataBean> list = new ArrayList<>();
        String imgUrl = "https://photo.16pic.com/00/50/60/16pic_5060403_b.jpg";
        String imgUrl2 = "https://photo.16pic.com/00/53/51/16pic_5351781_b.jpg";
        list.add(new DataBean(imgUrl, "相信自己,你努力的样子真的很美", 1));
        list.add(new DataBean(imgUrl2, "相信自己,你努力的样子真的很美", 1));
        list.add(new DataBean(imgUrl, "极致简约,梦幻小屋", 3));
        list.add(new DataBean(imgUrl2, "超级卖梦人", 3));
        list.add(new DataBean(imgUrl, "夏季新搭配", 1));
        list.add(new DataBean(imgUrl2, "绝美风格搭配", 1));
        list.add(new DataBean(imgUrl, "微微一笑 很倾城", 3));
        return list;
    }
